...
export const DOH_EPI_SCHEDULE: AgeGroup[] = [
    ...
    vaccines: [
      {
        ...
        whereToGet: {
          en: 'Free at BHS or RHU for children 6–59 months (RA 11525 Universal Flu Vaccination Act)',
          fil: 'Libre sa BHS o RHU para sa mga batang 6–59 buwan (RA 11525)',
          zh: '6–59月龄儿童在社区卫生站免费接种（RA 11525全民流感疫苗法）',
        },
        recurrence: {
          type: 'annual',
          intervalYears: 1,
  ...
  },
  {
    ...
    vaccines: [
      ...
      },
      {
        ...
        isFreeEPI: false,
        sideEffects: 'Soreness at injection site, mild fever.',
        postVaccineCare: 'Follow-up 2nd dose 6–12 months later.',
        whereToGet: {
        ...
        recurrence: {
          type: 'once-series',
          noteEN: 'First of 2 doses. Per PPS guidelines, start at 12 months. Give HepA2 booster 6–12 months later for lifetime protection.',
          noteFIL: 'Una sa 2 dosis. Ayon sa PPS, simulan sa 12 buwan. Ibigay ang HepA2 booster pagkatapos ng 6-12 buwan.',
          noteZH: '2剂系列第1针。按PPS指南，从12个月起接种。6-12个月后接种HepA2加强针，可获终身保护。',
        },
      },
      {
        code: 'HepA2',
  ...
  },
  {
    ...
    vaccines: [
      {
        code: 'DPTBooster',
        nameEN: 'Pentavalent Booster (DPT-HepB-Hib)',
        nameFIL: 'Pentavalent Booster (DPT-HepB-Hib)',
        nameZH: '五联疫苗加强针（DPT-HepB-Hib）',
        protectsAgainst: {
          en: 'Diphtheria, Pertussis, Tetanus, Hepatitis B, Hib meningitis',
          fil: 'Diphtheria, Pertussis, Tetanus, Hepatitis B, Hib meningitis',
          zh: '白喉、百日咳、破伤风、乙肝、Hib脑膜炎',
        },
        doses: 1,
