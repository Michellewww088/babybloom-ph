...
const s = StyleSheet.create({
  ...
  statsStrip:       { flexDirection: 'row', marginHorizontal: PAD, marginTop: 14, backgroundColor: Colors.surface, borderRadius: 20, padding: 14, shadowColor: Colors.shadowColor, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 16, elevation: 4, borderWidth: 1, borderColor: Colors.border },
  ...
  chartCard:        { backgroundColor: Colors.surface, borderRadius: 20, marginHorizontal: PAD, marginTop: 14, padding: 16, shadowColor: Colors.shadowColor, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 16, elevation: 4, borderWidth: 1, borderColor: Colors.border, alignItems: 'center' },
...
const mod = StyleSheet.create({
  ...
  input:         { backgroundColor: Colors.background, borderRadius: 12, borderWidth: 1, borderColor: Colors.border, paddingHorizontal: 16, paddingVertical: 12, fontSize: 14, color: Colors.dark, height: 52, fontFamily: 'PlusJakartaSans_400Regular' },
  error:         { fontSize: 12, color: Colors.danger, marginTop: 8, fontWeight: '600' },
  saveBtn:       { borderRadius: 14, height: 52, alignItems: 'center', justifyContent: 'center', shadowColor: NAP_COLOR, shadowOpacity: 0.35, shadowRadius: 10, elevation: 5 },
